(module
   ...
   (import "js" "inflate_into" (func $inflate_into_js (param anyref) (param anyref) (result anyref)))
   ...
   (func (export "inflate_into") (param $s (ref eq)) (param $t (ref eq)) (result (ref eq))
      (call $wrap (call $inflate_into_js (call $unwrap (local.get $s)) (call $unwrap (local.get $t)))))
)
